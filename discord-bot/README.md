...
This is an optional companion bot. It lets clan members submit dragon records and map pins from Discord, then Dragon Tracker users can import those submissions from the Clans tab.
...
4. In Supabase, run `supabase/migrations/0004_discord_bot_submissions.sql`.
